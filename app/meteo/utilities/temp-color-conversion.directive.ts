...
export class TempColorDirective {
    ...
    @Input() set bgColor(temp: number) {
        ...
        else if (temp < 0 && temp > -5) this.el.nativeElement.style.backgroundColor = 'rgba(0, 175, 190, 0.1)';
        else if (temp > 0 && temp <= 5) this.el.nativeElement.style.backgroundColor = 'rgba(240, 85, 20, 0.1)';
